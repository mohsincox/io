        	...
        	<div class="col-md-8 col-sm-offset-2">
            	<div class="box box-success">
                	<div class="box-header with-border">
                    	<h3 class="box-title">District Wise Ticket Report Form</h3> 
                	</div>
                	<div class="box-body">
                		...
                		<div class="col-sm-12">
    						...
    						<div class="card">
    							<div class="card-header">
    								<h3 class="text-center"><i class="fa fa-chart-bar"></i> <code><b>District Wise Ticket</b></code> Report Form</h3>
    							</div>
    							<div class="card-body">
    						  		
    								
                                    {!! Form::open(['url' => 'report/district-show', 'method' => 'get', 'class' => 'form-horizontal']) !!}
                                    ...
                                    <div class="form-group {{ $errors->has('district_id') ? 'has-error' : ''}}">
	                                    {!! Form::label('district_id', 'District', ['class' => 'col-3 col-sm-3 control-label required']) !!}
	                                    <div class="col-xs-9 col-sm-9">
	                                       {!! Form::select('district_id', $districtList, null, ['class' => 'form-control select2', 'placeholder' => 'Select District', 'required' => 'required']) !!}
	                                        <span class="text-danger">
